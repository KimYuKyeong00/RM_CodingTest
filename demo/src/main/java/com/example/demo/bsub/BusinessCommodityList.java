...
public class BusinessCommodityList {
	...
	public BusinessCommodityList() {
	}

	public BusinessCommodityList(String commodity_id, int subscriber, int service_price, int storage_price) {
		super();
